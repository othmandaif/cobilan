    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          ...
          <button onClick={() => navigate('/factures-vente')} className="mt-4 text-sm text-cobilan-600 hover:underline">Retour</button>
        </div>
      </div>
    );
  }
      ...
      <div className="print-content max-w-[210mm] mx-auto bg-white">
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm font-semibold text-gray-900">{invoice.customer_name || invoice.customer}</p>
          </div>
